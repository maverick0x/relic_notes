                      ...
                      children: <Widget>[
                        ...
                        TextFormField(
                          decoration: InputDecoration(
                            ...
                            prefixIcon:
                                Icon(LineIcons.user, color: Colors.black45),
                          ),
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            prefixIcon:
                                Icon(LineIcons.at, color: Colors.black45),
                          ),
                        ...
                        TextFormField(
                          decoration: InputDecoration(
                            ...
                            prefixIcon:
                                Icon(LineIcons.phone, color: Colors.black45),
                          ),
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            prefixIcon:
                                Icon(LineIcons.key, color: Colors.black45),
                          ),
                          keyboardType: TextInputType.text,
...
class RegisterPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path2.quadraticBezierTo(paintWidth * 0.65, paintHeight * 0.30,
        paintWidth * 0.68, paintHeight * 0.7);
    path2.quadraticBezierTo(
        paintWidth * 0.71, paintHeight * 0.9, paintWidth * 0.95, paintHeight);
